...
@section('content')
    ...
    <div class="row g-4">
        <div class="col-md-8">
            ...
            <p>
                Modul ini dirancang untuk mahasiswa semester awal yang baru mulai belajar pemrograman web. Setiap bab disusun secara sistematis
                dengan penjelasan yang mudah dipahami dan contoh kode yang dapat langsung dipraktikkan.
            </p>
